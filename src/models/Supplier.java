...
public class Supplier extends DB {
    ...
    public static void getAll() {
        ...
        try {
            ...
            PreparedStatement statement = query.prepareStatement("SELECT * FROM suppliers WHERE is_deleted = false AND name <> 'RESERVED'");
    ...
    public static ArrayList getName() {
        ...
        try {
            Connection query = connect();
            PreparedStatement statement = query.prepareStatement("SELECT id, name FROM suppliers WHERE is_deleted = false AND name <> 'RESERVED'");
            ResultSet result = statement.executeQuery();
            while (result.next()) {
